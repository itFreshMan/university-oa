...
Ext.reg('moduleField', ST.ux.ExtField.ComboBox);
...
ST.base.dictView = Ext.extend(ST.ux.ViewGrid, {
	...
	dlgHeight: 260,
	//资源列表查询URL
	urlGridQuery: '/dict/pageQueryDictTypes.json',
	urlAdd: '/dict/insertDictType.json',
	urlEdit: '/dict/updateDictType.json',
	urlLoadData: '/dict/loadDictType.json',
	urlRemove: '/dict/deleteDictTypes.json',
	
	urlAddDict: '/dict/insertDictEntry.json',
	urlEditDict: "/dict/updateDictEntry.json",
	urlRemoveDict: "/dict/deleteDictEntries.json",
	urlLoadDict: "/dict/loadDictEntry.json",
	urlEastGridQuery: '/dict/pageQueryDictEntries.json',
	addTitle: "增加字典类型",
    editTitle: "更新字典类型",
    gridTitle: "业务字典数据",
    dialogLabelWidth: 80,
	...
	girdColumns: [
				...
				{header: '模块名称', width:100, hideGrid: true, showAll:false, sortable: true, hiddenName: 'module', dictTypeCode: 'CORE.MODULE', fieldtype:'moduleField', dataIndex: 'module'},
		        {header: '模块名称', width:100, dataIndex: 'module_Name', hideForm: 'all'},
	            ...
	            {id:'descn',header: '描述', width: 250, dataIndex: 'memo', fieldtype:'textarea'}
	        ],
	queryFormHeight:100,
	queryFormItms: [{ 
				layout: 'tableform',
		        ...
		        items:[{xtype:'moduleField', hiddenName: 'module',dictTypeCode: 'CORE.MODULE',fieldLabel: '模块名称',anchor:'80%', allowBlank:true },
		               {xtype:'textfield', fieldLabel: '字典类型名称', name: 'name', id: 'name', anchor:'80%' }] 
		    }],
	...
	eastGridColumn: [{header: "ID", width: 120, dataIndex: 'id',name: 'id',hideGrid: true, hideForm: 'add', readOnly: true},
			...
			{header: 'DICT_TYPE_ID', width: 150, name: 'dictType.id', hideGrid: true,fieldtype:'hidden',id: 'dictType.id'},
	...
	setDictDefaultValue: function(id){
    	Ext.getCmp("dictType.id").setRawValue(this.rid);
 ...
 // 初始化ColumnModel
    ...
    rowclickFn: function(grid, rowIndex, e) {
    	...
    	if(this.rid == grid.getStore().getAt(rowIndex).data.id)
    		this.rid == '';
    	else
